...
public class GUISmithItemEvent extends Event implements Cancellable {
	...
	public GUISmithItemEvent(CustomGUIBlueprint customGUIBlueprint, InventoryClickEvent e) {
