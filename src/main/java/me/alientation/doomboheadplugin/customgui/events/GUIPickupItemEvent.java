...
public class GUIPickupItemEvent extends Event implements Cancellable {
	...
	public GUIPickupItemEvent(CustomGUIBlueprint customGUIBlueprint, InventoryClickEvent e) {
