...
public class GUIPlayerActionEvent extends Event implements Cancellable {
	...
	public GUIPlayerActionEvent(CustomGUIBlueprint customGUIBlueprint, InventoryClickEvent e) {
