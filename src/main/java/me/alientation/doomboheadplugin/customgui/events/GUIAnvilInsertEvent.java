...
public class GUIAnvilInsertEvent extends Event implements Cancellable {
	...
	public GUIAnvilInsertEvent(CustomGUIBlueprint customGUIBlueprint, InventoryClickEvent e) {
