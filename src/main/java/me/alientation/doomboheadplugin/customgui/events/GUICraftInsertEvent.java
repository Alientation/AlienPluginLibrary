...
public class GUICraftInsertEvent extends Event implements Cancellable {
	...
	public GUICraftInsertEvent(CustomGUIBlueprint customGUIBlueprint, InventoryClickEvent e) {
