...
public class GUIPlayerInventoryClickEvent extends Event implements Cancellable {
	...
	public GUIPlayerInventoryClickEvent(CustomGUIBlueprint customGUIBlueprint, InventoryClickEvent e) {
